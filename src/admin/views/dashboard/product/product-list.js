...
const ProductList = () => {
  ...
  const productDeleted = (id) => {
    deleteDataProduct(id).then(() => {
      setDel(!del);
    });
  };

  const editProduct = () => {
    updateDataProduct(updatePro.id, updatePro).then(() => {
      setShow(false);
                  ...
                  <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body className="row">
                      ...
                      >
                        ...
                        <Form.Control
                          type="text"
                          defaultValue={updatePro.productName}
                          onChange={(e) =>
                            setUpdatePro({
                              ...updatePro,
                      ...
                      >
                        ...
                        <Form.Control
                          type="text"
                          defaultValue={updatePro.quantity}
                          onChange={(e) =>
                            setUpdatePro({
                              ...updatePro,
