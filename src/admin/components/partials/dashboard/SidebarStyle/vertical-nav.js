          ...
          <Accordion.Collapse eventKey="sidebar-auth">
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/admin/auth/sign-in" ? "active" : ""
                  } nav-link`}
              ...
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/admin/auth/sign-up" ? "active" : ""
                  } nav-link`}
            ...
            <ul className="sub-nav">
              {/* <li className="nav-item">
                <Link
                  ...
                  to="/admin/dashboard/app/user-profile"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/admin/dashboard/app/user-add"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/admin/dashboard/app/user-add"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/admin/dashboard/app/user-list"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/admin/dashboard/app/user-list"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  ...
                  to="/admin/dashboard/product/product-add"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="nav-item">
                <Link
                  ...
                  to="/admin/dashboard/product/product-list"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
